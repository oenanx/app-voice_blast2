...
<div class="col-md-10">
	<div class="card card-danger" style="width:100%;">		
		<div class="card-header with-border">
			<h3 class="card-title" style="color:red"><i class="fas fa-edit" data-card-widget="collapse"></i> Data Header, Schedule, & Upload</h3> 
		</div><!-- /.card-header -->	
		<div class="card-body" style="width:100%; display: none;" align="justify">
				...
				<div class="row">
					...
					<div class="col-md-6 col-lg-6">
						<div class="form-group">
							...
							<textarea id="form_message" name="form_message" class="form-control form-control-sm" placeholder="Format Pesan Blast" required rows="5" maxlength="8000" style="resize: none;"></textarea>
							<span class="help-block" style='color:red;'></span>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-6 col-lg-6 date">
						<div class="form-group">
							...
							<textarea id="description" name="description" class="form-control form-control-sm" placeholder="Deskripsi" required rows="3" maxlength="800" style="resize: none;"></textarea>
							<span class="help-block" style='color:red;'></span>
						</div>
					</div>
				</div>
			...
			<h3 class="card-title" style="color:red"><i class="fa fa-clock"></i> Data Scheduler & Upload Detail</h3>
			<div class="container" align="justify">
				<div class="row">
					<table id="myTable" class="table table-bordered" role="grid" style="width: 100%; font-size:9pt;">
						<thead>
							<tr>
								...
								<th width="40%"><center>Upload File *</center></th>
				...
				<div class="row">
					...
					<!--<button type="button" class="btn btn-primary btn-sm" onclick="save()">Save</button>&nbsp;-->
						<button type="submit"  id="sub" onclick="save()" class="btn btn-info btn-sm btn-outline-primary">UPLOAD</button>&nbsp;
	...
	<div class="card card-danger" style="width:100%;">
		<div class="card-header with-border">
			<h3 class="card-title" style="color:red"><i class="fa fa-th-list"></i> View List Api</h3>
		</div>
		...
		<div class="modal-content">
			<div class="card">
				<div class="card-header">
					<h2 class="card-title"><b>View Detail Product API</b></h2>
				</div>
...
<div id="view-modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="card">
				<div class="card-header">
					<h2 class="card-title"><b>Edit Detail Product API</b></h2>
				</div>
						...
						<div class="card-body" align="justify">
							<table style="width:100%; font-size:10pt;" border="0">
								...
								<tr style="line-height: 1.0;">
									<td align="left" style="width:20%;"> Format Message </td>
									<td align="center" style="width:3%;">:</td>
									<td align="left" style="width:77%;"> <textarea class="form-control form-control-sm" name="fmsg2" rows="3" required style="resize: none;"></textarea></td>
								</tr>
								<tr style="line-height: 1.0;">
									<td align="left" style="width:20%;"> Description </td>
									<td align="center" style="width:3%;">:</td>
									<td align="left" style="width:77%;"> <textarea class="form-control form-control-sm" name="desc2" rows="2" required style="resize: none;"></textarea></td>
								</tr>
								<tr style="line-height: 1.0;">
									<td align="left" style="width:20%;"> Start Date </td>
									<td align="center" style="width:3%;">:</td>
				...
				success: function(data2)
				{
					...
					for(var j = 0; j < data2.length;  j++ ) 
					{
						trHTML += 
							...
							'<td style="width:25%;" align="center">' + data2[j].batchid + '</td>' + 
							
							'<td style="width:25%;" align="center">' + data2[j].start_datetime + '</td>' + 
							
							'<td style="width:25%;" align="center">' + data2[j].end_datetime + '</td>' + 
							
							'<td style="width:25%;" align="center">' + data2[j].active + '</td>' + 
				...
				success: function(data2)
				{
					...
					for(var l = 0; l < data2.length;  l++ ) 
					{
						trHTML += 
							...
							'<td style="width:25%;" align="center"><input type="hidden" style="font-size:10pt;" id="batchid2" name="batchid2" class="form-control form-control-sm timepicker" required value="' + data2[l].batchid + '" />' + data2[l].batchid + '</td>' + 
							
							'<td style="width:25%;" align="center"><input type="text" style="font-size:10pt;" id="starttime2" name="starttime2" class="form-control form-control-sm timepicker" required placeholder="(HH:mm:ss)" value="' + data2[l].start_datetime + '" /></td>' + 
							
							'<td style="width:25%;" align="center"><input type="text" style="font-size:10pt;" id="endtime2" name="endtime2" class="form-control form-control-sm timepicker" required placeholder="(HH:mm:ss)" value="' + data2[l].end_datetime + '" /></td>' + 
